...
$_LANGMAIL['Your guest account for <span><strong>{shop_name}</strong></span> has been transformed into a customer account.'] = 'Your guest account for <span><strong>{shop_name}</strong></span> has been transformed into a customer account.';
...
$_LANGMAIL['Order cancelled'] = 'Order cancelled';
$_LANGMAIL['Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been cancelled.'] = 'Your order with the reference <span><strong>{order_name}</strong></span> from <span><strong>{shop_name}</strong></span> has been cancelled.';
...
$_LANGMAIL['You will soon receive a URL to track the delivery progress of your package.'] = 'You will soon receive a URL to track the delivery progress of your package.';
...
$_LANGMAIL['A new order was placed on {shop_name} from the following customer: {firstname} {lastname} ({email})'] = 'A new order was placed on {shop_name} from the following customer: {firstname} {lastname} ({email})';
